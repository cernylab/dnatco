...
export const browse = [
    {
        ...
        sections: {
            ...
            contourPlots: {
                ...
                paragraph1: 'The final tab, "Contour Plots," enables users to examine the distribution of NtC steps within each conformer class in two distinct ways: in the RSCC/RMSD space and in the RSCC/torsion space. These plots are presented separately for structures with resolutions better than 1.8Å and those with resolutions worse than 2.5Å. This examination provides valuable insights into the relationship between the quality of fit into electron density maps and the quality of alignment between the actual step atomic coordinates or torsion parameters and those of an NtC conformer reference structure.'
            },
        }
    }
]