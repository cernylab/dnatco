...
export const  refinement = [
    {
        ...
        sections: {
            connectivityPlot: {
                ...
                paragraph1: 'The "Connectivity Plot" tab features two connectivity plots. The connectivity plots are designed to illustrate how well-connected the structure would be if the components of the structure making up the previous, currently selected, and next steps were all replaced by reference NtCs.',
