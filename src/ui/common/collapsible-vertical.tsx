...
export class CollapsibleVertical extends React.Component<
  CollapsibleVertical.Props,
  State
> {
  ...
  componentDidUpdate(prevProps: CollapsibleVertical.Props, prevState: State) {
    if (
      this.props.onCollapsedExpanded &&
  ...
  render() {
    return (
      <div
        className="rdo-collapsible-vertical text-primary-first transition-all overflow-hidden flex flex-col border-b-primary-first border-b-[.1px]"
