...
export class DynamicSplitView extends React.Component<
  DynamicSplitView.Props,
  State
> {
  static defaultProps = {
    visible: "both",
  ...
  private defaultSelectStart: typeof HTMLBodyElement.prototype.onselectstart =
    null;
  ...
  adjustWidth = (evt: MouseEvent) => {
    ...
    const x =
      (evt.clientX - tainer.getBoundingClientRect().left) / tainer.clientWidth;
  ...
  adjustHeight = (evt: MouseEvent) => {
    ...
    const tainer = this.tainerRef.current!;
    const y =
      (evt.clientY - tainer.getBoundingClientRect().top) / tainer.clientHeight;
  ...
  private finalizeAdjust() {
    ...
    if (this.props.onAdjustDone) this.props.onAdjustDone();
  }
      ...
      <div
        ...
        style={
          this.props.orientation === "horizontal"
            ? this.props.visible === "first"
              ? StyleFullFirstHorizontal
              : StyleFullSecondHorizontal
            : this.props.visible === "first"
            ? StyleFullFirstVertical
            : StyleFullSecondVertical
        }
      >
        {this.props.first}
  ...
  private renderBoth() {
    ...
    const splitterBarStyle =
      this.props.orientation === "horizontal"
        ? {
            width: "50%",
            height: "100%",
            backgroundColor: "#30595c",
            marginLeft: "auto",
            marginRight: "auto",
          }
        : {
