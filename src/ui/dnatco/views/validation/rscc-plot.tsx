...
export class RsccPlot extends View<View.Props, State> {
    ...
    private makePlotData(): { assigned: _RsccPlot.RsccPlotData, unassigned: _RsccPlot.RsccPlotData } {
    ...
    private renderPlot(xy: _RsccPlot.RsccXYData, contour: _RsccPlot.RsccContourData) {
