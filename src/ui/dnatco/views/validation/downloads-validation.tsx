...
import { SerializeByResidue, SerializeByCompound } from '../../../../dnatco/angles-lengths/serialize';
...
import { ImageSerialization } from '../../../../util/image-serialization';import { GlobalConfig } from '../../../../global-config';
...
export function DownloadsValidation(props: { dnatcofication: Dnatcofication }) {
...
export namespace DownloadsValidation {
