...
export class BackboneQuality extends View<View.Props> {
    ...
    private readonly Searching: SearchBox.Searching<Step> = {
        ...
        onUseResult: (step) => {
            const sel = BackboneQuality.SelectionMaker(step.id, InvalidResidue, InvalidAtom, this.props.structureSelection.steps, this.props.structureSelection.residues, this.props.structureSelection.atoms, this.props.dnatcofication);
            this.props.switching.changeSelection(sel, BackboneQuality.SelectionDisplayer);
        }
    }
    ...
    private makeTableModel(selectedModelNum: number, selectedChain?: string) {
        ...
        const stepColumn: DynamicTable.Column<string> = {
            name: 'Dinucleotide', cells: new Array<DynamicTable.Cell<string>>(), alignment: 'center', notSortable: true,
        ...
        const confalColumn: DynamicTable.Column<number> = {
            name: 'Confal score', cells: new Array<DynamicTable.Cell<number>>(), alignment: 'center', cellStyle: confalToColor,
            ...
            <DynamicTableComp
                ...
                onCellClicked={(data, row, colName) => {
                    ...
                    if (stepId !== InvalidStepId) {
                        const sel = BackboneQuality.SelectionMaker(stepId, InvalidResidue, InvalidAtom, this.props.structureSelection.steps, this.props.structureSelection.residues, this.props.structureSelection.atoms, this.props.dnatcofication);
                        this.props.switching.changeSelection(sel, BackboneQuality.SelectionDisplayer);
                    }
                }}
...
export namespace BackboneQuality {
