...
import { InvalidChain, InvalidModelIndex} from '../../../../util/structure-selection';
        ...
        return (
            <div>
                ...
                <div>
                    ...
                    <div>{`Percentile:\u00A0${this.props.confalPercentile.toFixed(0)}`}</div>
...
export class OverallQuality extends View<View.Props> {
    ...
    render() {
        ...
        const modelIdxx = this.props.structureSelection.modelIndex === InvalidModelIndex ? 0 : this.props.structureSelection.modelIndex;
        const confalAverage = this.props.dnatcofication.data.averageConfals[modelIdxx];
        ...
        return (
            <div style={{ ...Common.VScrollJail, position: 'relative' }} ref={selfRef}>
                ...
                <div className='font-700 mb-2 p-2 text-center border-b border-primary-first'>Valence geometry quality</div>
